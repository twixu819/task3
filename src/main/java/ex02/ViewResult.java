...
public class ViewResult implements View {
    ...
    public void viewHeader() { System.out.println("View Result: "); }
    public void viewFooter() { System.out.println("End of Report "); }
    public void viewBody() {
        for (Item2d item : items) {
            System.out.println("U=" + item.u + "V, R=" + item.r + " Ohm, I=" + item.binaryI);
        }
    }
